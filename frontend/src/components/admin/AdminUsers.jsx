...
export default function AdminUsers() {
  ...
  const [showDisabledUsers, setShowDisabledUsers] =
      useState(false)
  ...
  function handleStartEdit(user) {
    ...
    // Пароль никогда не подставляем при редактировании.
    setEditPassword('')
  ...
  async function handleDeleteUser(user) {
    ...
    try {
      ...
      /*
       * Backend использует soft delete:
       * пользователь остаётся в БД,
       * но enabled становится false.
       *
       * Поэтому не удаляем пользователя
       * из массива, а сразу обновляем его.
       */
      setUsers((currentUsers) =>
          currentUsers.map(
              (currentUser) =>
                    ...
                    >
                      <div className="admin-section-heading admin-section-heading-toggle">
                        ...
                        <div>
                          ...
                          <p>
                            Пользователи без доступа к системе
                          </p>
                        </div>
